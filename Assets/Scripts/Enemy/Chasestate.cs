...
// so here once the enemy has spotted the player, it moves toward them by following the pathfinding route
public class ChaseState : IEnemyState
{
    public void Tick(Enemy enemy)
    {
        ...
        // close enough AND a clear line of sight. only then attack
